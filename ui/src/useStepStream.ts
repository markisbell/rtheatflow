 ...
 *  (1.5 s). Hardened against React 18 StrictMode double-mounts: a `stopped`
 *  flag plus per-socket identity guards ensure only the live socket updates
 *  state; malformed frames are ignored. (Verbatim blueprint port.) */
